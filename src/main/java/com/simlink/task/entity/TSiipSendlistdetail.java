...
public class TSiipSendlistdetail implements java.io.Serializable {
	...
	public TSiipSendlistdetail() {
		super();
	}

	public TSiipSendlistdetail(String id, String CSendlistcd,
			String creatorcd, String creatorname, Date createtime,
			String CPatientid, String CPatientname,
			...
			String CDrugusagename, String CDrugusetimesdaycd,
			String CDrugusetimesdayname, String CDoctorcd,
			String CDoctorname, String area, String institution) {
		this.id = id;
	...
	public TSiipSendlistdetail(String id, String CSendlistcd,
			String creatorcd, String creatorname, Date createtime,
			String CPatientid, String CPatientname,
			String CPatientnamepycode, String CDrugcd,
			String CCommonname, String CTradename,
			String CDrugspec, String CFigurename,
			String CFactoryname, String CBatchcd,
			String CBatchdetail, String CDrugpackunitcd,
			...
			String CDrugusetimesdaycd, String CDrugusetimesdayname,
			String CDoctorcd, String CDoctorname,
			String CDoctoradvice, String CBedcd,
			String CDaytime, String CDosage, String area,
			String institution) {
		this.id = id;
		this.CSendlistcd = CSendlistcd;
		this.creatorcd = creatorcd;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSiipSendlistdetail))
			return false;
		TSiipSendlistdetail castOther = (TSiipSendlistdetail) other;
